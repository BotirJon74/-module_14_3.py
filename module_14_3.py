...
async def get_buying_list(message):
    with open('1.png', 'rb') as img:
        await message.answer_photo(img,f'Название:Product1 | Описание:Напиток 1 | Цена: {1*100}')
    with open('2.png', 'rb') as img:
        await message.answer_photo(img,f'Название:Product2 | Описание:Напиток 2 | Цена: {2*100}')
    with open('3.png', 'rb') as img:
        await message.answer_photo(img,f'Название:Product3 | Описание:Напиток 3 | Цена: {3*100}')
    with open('4.png', 'rb') as img:
        await message.answer_photo(img,f'Название:Product4 | Описание:Напиток 4 | Цена: {4*100}')
